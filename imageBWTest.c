...
int main(int argc, char *argv[])
{
  ...
  Image image_6 = ImageCreateChessboard(6,6,3,1);
  ImageRAWPrint(image_6);

  Image image_7 = ImageCreateChessboard(6,6,3,0);
  ImageRAWPrint(image_7);

  Image image_8 = ImageReplicateAtRight(image_6, image_7);
  ImageRAWPrint(image_8);

  Image image_9 = ImageReplicateAtBottom(image_6, image_6);
  ImageRAWPrint(image_9);

  Image image_10 = ImageHorizontalMirror(image_7);
  ImageRAWPrint(image_10);

  Image image_11 = ImageVerticalMirror(image_6);
  ImageRAWPrint(image_11);

  // Saving in PBM format
  ImageSave(image_6, "image6.pbm");
  ImageSave(image_7, "image7.pbm");
  ImageSave(image_8, "image8.pbm");
  ImageSave(image_9, "image9.pbm");
  ImageSave(image_10, "image10.pbm");
  ImageSave(image_11, "image11.pbm");
 ***/
